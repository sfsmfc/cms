...
return [
    ...
    '<code>allowAdminChanges</code> is off. You can view the settings, but not change them.' => '<code>allowAdminChanges</code> is off. You can view the settings, but not change them.',
